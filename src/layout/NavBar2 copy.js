...
function DistanceButton({ isActive = false, onClick }) {
  return (
...
function ZipCodeFilters({ selectedZip, onZipChange, zipCodeOptions, selectedZipData }) {
...
function LocationFilters({ zipCodes = [], selectedLocationZip, setSelectedLocationZip }) {
  // Local state for county and city cascading filters
  ...
  // Get neighborhood for selected zip
...
export default function NavBar2() {
  ...
  // Handler to switch modes - clears all filter state
