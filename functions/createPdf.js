...
// June 2026 trial: temporarily opened Create PDF to guests (unauthenticated) to
// gauge usage. Closed again 2026-07-01 — PDF is registered-orgs-only. Must be
// kept in sync with the UI lever (GUEST_EMAIL_PDF_OPEN in src/layout/NavBar1.js)
// and the matching flag in functions/sendEmail.js. (Text/SMS stays open to
